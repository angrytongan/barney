import{S as Y,i as q,s as V,e as b,a5 as N,k as C,c as y,a as k,a6 as $,n as z,d as i,b as c,f as S,D as d,E as D,t as v,g as w,M as R,A as K,W as Q,a7 as j,a2 as Z,a3 as P}from"../../chunks/vendor-656fd6d9.js";function I(p,e,h){const s=p.slice();return s[4]=e[h],s}function J(p){let e,h,s=p[4].content+"",n,T;return{c(){e=b("div"),h=new N,n=C(),this.h()},l(l){e=y(l,"DIV",{id:!0,class:!0});var m=k(e);h=$(m),n=z(m),m.forEach(i),this.h()},h(){h.a=n,c(e,"id",T=p[4].id),c(e,"class","svelte-13w4bp8")},m(l,m){S(l,e,m),h.m(s,e),d(e,n)},p:D,d(l){l&&i(e)}}}function F(p){let e,h,s,n,T,l,m,M,g,H,E,x,u,A,f,_=p[0],r=[];for(let t=0;t<_.length;t+=1)r[t]=J(I(p,_,t));return{c(){e=b("p"),h=v("A quick hack combining "),s=b("a"),n=v(`GreenSock's
...
<a href="http://www.gutenberg.org/files/2346/2346-h/2346-h.htm">Project Gutenberg</a>
            ...
            `}];return K(()=>{j.accessToken="pk.eyJ1IjoiYW5ncnl0b25nYW4iLCJhIjoiY2t2YnMxZWdvMGc2bTJ2bnl3M3d0NGN3eSJ9.g4_hwrsAOY5KMJrb5fzM1Q",e=new j.Map({container:"map",style:"mapbox://styles/mapbox/streets-v11",center:[-.15591514,51.51830379],zoom:9}),Z.exports.gsap.registerPlugin(P.exports.ScrollTrigger),P.exports.ScrollTrigger.defaults({start:"top 30%",end:"bottom top",pin:!0,scrub:!0}),s.forEach(n=>{P.exports.ScrollTrigger.create({trigger:`#${n.id}`,onEnter:()=>{e.flyTo(n)},onEnterBack:()=>{e.flyTo(n)}})})}),Q(()=>{h.forEach(n=>{n.kill()})}),[s]}class ee extends Y{constructor(e){super();q(this,e,U,F,V,{})}}export{ee as default};
